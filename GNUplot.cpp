...
const TCHAR GNUPLOTEXE[] = TEXT("C:\\Users\\Ahmed Abd El Magid\\Downloads\\osass2\\OpreatingSystemAss_2\\OpreatingSystemAss_2\\GnuPlot\\GnuPlot\\binary\\gnuplot.exe");
...
std::string GNUPlotInterface::Init(const CHAR *gnuplotLINETYPE, const CHAR *gnuplotTITLE){
	...
	*	term macintosh*/
	...
	gnuplotCommand.append("set yrange [0:20] \n");
	//gnuplotCommand.append("set xrange [0:100] \n");
	gnuplotCommand.append("set ytics 1 \n");
	gnuplotCommand.append("set xtics 4 \n");
